...
- Provide explicit command suggestions: e.g., "Run /tchnncrt with refinement", "Run /plan to adjust architecture", "Manually edit tasks.md to add coverage for 'performance-metrics'"
